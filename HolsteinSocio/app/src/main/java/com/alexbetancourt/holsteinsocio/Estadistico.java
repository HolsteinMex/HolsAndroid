...
public class Estadistico {
    ...
    public Estadistico(int id, String noHato, Date fechaVisita, String region, String estado,
                       int vacasHato, double lechekgH, double lecheEM, double diasLeche,
                       double pVacasCarga, double diasPico, double lechePico, int pDesecho,
                       double edadMM, int dias1Serv, int pFertil1Serv,
                       double interServ, double servxConc, int diasAb, double interPartos,
                       double pAbortos, double pGrasa, double pProteina, double pSolidos,
                       double nitrogU, int cCSMiles) {
        this.id = id;
        this.noHato = noHato;
